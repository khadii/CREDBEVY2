...
const Deactivate: React.FC<ModalProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    >
      <div className="relative bg-white rounded-lg w-full max-w-md mx-4">
        ...
        <div className="flex pl-6 pt-6 pr-4 justify-between w-full items-center">
          <h2 className="text-2xl font-semibold text-[#333333]"> Deactivate Loan Product </h2>
          <button
            onClick={onClose}
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full text-center">
              <p className="text-2xl font-semibold text-[#333333] mb-6">
                Are you sure you want to deactivate the selected loan product?
              </p>
              <p className="mb-10 text-[#8A8B9F] text-sm font-semibold">
                Once you deactivate this, it will no more be available
              </p>
            </div>
          </div>
