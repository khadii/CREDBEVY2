...
import { Policy } from "@/app/Redux/acceptprivacypolicy/policy_thunk";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#17191CBA] p-4">
      <div className="bg-white shadow-lg rounded-lg w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="px-6 pb-4 text-sm">
          <p className="mb-2">
            Welcome to the Credbevy Lenders Distribution. At Credbevy, your
            privacy and data security are paramount. This Privacy Policy
            outlines how we collect, use, disclose, and protect your information
            when you access and use our Lenders Dashboard, particularly during
            initial onboarding and account creation.
          </p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-2 text-sm border-t border-b border-gray-200">
          <Section num={1} title="Who We Are">
            <p>
              ...
              verified borrowers with eligible lenders. Our Lenders Dashboard is
              a secure portal enabling lenders to manage borrower applications,
              access financial intelligence, and configure their lending
              preferences.
            </p>
          </Section>
          ...
          <Section num={2} title="Scope of The Policy">
            <p>
              The Privacy Policy applies exclusively to data collected from
              lenders (and their authorized representatives) upon first-time
              access to the Lenders Dashboard. It supplements the general
              Credbevy Privacy Policy available at{" "}
              <a
                href="https://www.credbevy.com/privacy"
                className="text-blue-600 hover:underline"
              >
                www.credbevy.com/privacy
              </a>
              .
            </p>
          </Section>
          ...
          <Section num={3} title="Information We Collect">
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Parties Information: Legal name, registration/incorporation
                  number, tax ID, licensing information, business type, address,
                  and contact details.
                </li>
                <li>
                  Authorised User Information: Full name, title/role, work
                  email, phone number, login credentials.
                </li>
                <li>
                  Due Diligence/KYC Documentation: Regulatory licenses, AML
                  policies, financial reports, ownership documents.
                </li>
              </ul>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Login and Usage Data: Timestamps, IP address, session
                  duration, user interactions (clicks, navigation paths).
                </li>
                <li>
                  Device Information: Browser type, operating system, device ID.
                </li>
                <li>
                  Activity Logs: Access logs, application review history,
                  decision timestamps.
                </li>
              </ul>
          ...
          <Section num={4} title="Legal Basis for Processing">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                Contractual necessity: To create and manage your lender account
                and provide platform functionality.
              </li>
              <li>
                Legal compliance: To fulfil regulatory requirements (e.g., KYC,
                AML).
              </li>
              <li>
                Legitimate interest: To improve our services, prevent fraud, and
          ...
          <Section num={5} title="How We Use Your Information">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                Verify your identity and regulatory standing during onboarding.
              </li>
              <li>Enable secure login and role-based access.</li>
              <li>Match borrower applications under your lending criteria.</li>
              <li>
                Present financial statements, analytics, and portfolio insights.
              </li>
              <li>
                Facilitate communication between lenders and Credbevy or
                borrowers (where applicable).
              </li>
              <li>
                Monitor usage and ensure compliance with Credbevy's Terms of
                Service.
              </li>
            </ul>
          </Section>
          ...
          <Section num={6} title="Data Security and Disclosure">
            <p>
              We do not sell or rent your data. We may share your data only
              under the following conditions:
            </p>

            <p>A. With Your Consent</p>
            <p>
              For example, when you need to access borrower profiles or
              analytics dashboards powered by third-party integrations.
            </p>
          ...
          <Section num={7} title="Data Retention">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Comply with regulatory retention mandates (e.g., 5-7 years for
                financial records).
              </li>
              <li>Enforce contractual agreements and resolve disputes.</li>
            </ul>
            <p>
              Data may be anonymized for research and analytics after retention
              periods expire.
            </p>
          </Section>
          ...
          <Section num={8} title="Data Security">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                Encryption: All data is encrypted both in transit (TLS 1.2+) and
                at rest (AES-256).
              </li>
              <li>
                Multi-Factor Authentication (MFA): Required for all dashboard
                access.
              </li>
              <li>
                Audit Logs: Continuous monitoring of system access and usage
                patterns.
              </li>
              <li>
                Access Controls: Role-based permissions and internal access
                limitations.
              </li>
            </ul>
          </Section>
          ...
          <Section num={9} title="Your Rights and Choices">
            <p>
              Depending on your location and applicable laws (e.g., GDPR, NDPR),
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Portability – Receive a copy of your data in machine-readable
                format.
              </li>
              <li>
            ...
            <p>
              ...
              <a
                href="mailto:Support@credbevy.com"
                className="text-blue-600 hover:underline"
              >
                Support@credbevy.com
              </a>{" "}
              with subject: Data Request - Lenders Dashboard.
            </p>
          </Section>

          <Section num={10} title="International Data Transfers">
            <p>
              If you access Credbevy from outside the country where our servers
              are located, your data may be transferred across borders. We
              implement safeguards such as Standard Contractual Clauses (SCCs)
              or equivalent under applicable data protection laws.
            </p>
          </Section>
          ...
          <Section num={11} title="Changes to This Privacy Policy">
            <p>
              ...
              be communicated via the dashboard or email at least 7 days before
              taking effect. Continued use of the dashboard constitutes
