...
export default function ProfileCard({ loanUuid }: ProfileCardProps) {
  ...
  if (loading) {
    return <div className="bg-[#FFFFFF] flex flex-col items-center rounded-lg text-center h-[1100px] border-[1px] justify-center">Loading profile...</div>;
  }
  ...
  if (!loanData) {
    return <div className="bg-[#FFFFFF] flex flex-col items-center rounded-lg text-center h-[1100px] border-[1px] justify-center">No profile data available</div>;
  }
